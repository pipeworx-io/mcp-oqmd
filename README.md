...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_materials \
  -H 'Content-Type: application/json' \
  -d '{"composition":"Fe2O3"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_materials`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
